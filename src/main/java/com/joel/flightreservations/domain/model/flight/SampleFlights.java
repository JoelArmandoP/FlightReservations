...
public class SampleFlights {
    ...
    public static final Flight BA149 = new Flight(
            ...
            SampleAirports.HAMBURG.getTimeStamp(2016, 4, 15, 16, 30), 200.0f);
    public static final Flight AA030 = new Flight(
            ...
            SampleAirports.CHICAGO, SampleAirports.CHICAGO.getTimeStamp(2016, 5, 15, 16, 30), 500.0f);
    public static final Flight M8255 = new Flight(
            ...
            SampleAirports.HONGKONG, SampleAirports.HONGKONG.getTimeStamp(2016, 5, 15, 16, 30), 100.0f);
