...
public class SampleReservations {
    ...
    public static final Reservation reservation2 = new Reservation(SampleUsers.user2, 0,2,null);
    public static final Reservation reservation3 = new Reservation(SampleUsers.user3, 0,2,null);
    public static final Reservation reservation4 = new Reservation(SampleUsers.user4, 0,2, null);
}
